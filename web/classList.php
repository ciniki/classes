...
// -------
//
function ciniki_classes_web_classList($ciniki, $settings, $tnid, $args) {
    ...
    //
    // Based on the options enabled for the tenant, determine how the returning list
    ...
    if( isset($args['category']) && $args['category'] != '' ) {
        ...
        if( ($ciniki['tenant']['modules']['ciniki.classes']['flags']&0x01) > 0 ) {
