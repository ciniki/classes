...
// -------
//
function ciniki_classes_classImageGet($ciniki) {
    //  
    ...
    //
    $strsql = "SELECT ciniki_class_images.id, "
        . "ciniki_class_images.name, "
        . "ciniki_class_images.permalink, "
        . "ciniki_class_images.webflags, "
    ...
    if( !isset($rc['images']) ) {
        return array('stat'=>'ok', 'err'=>array('code'=>'ciniki.classes.22', 'msg'=>'Unable to find image'));
    }
