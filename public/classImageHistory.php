...
function ciniki_classes_classImageHistory($ciniki) {
	...
	$rc = ciniki_classes_checkAccess($ciniki, $args['business_id'], 'ciniki.classes.classImageHistory');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.classes', 'ciniki_classes_history', 
		$args['business_id'], 'ciniki_class_images', $args['class_image_id'], $args['field']);
}
?>
