...
function ciniki_classes_classUpdate(&$ciniki) {
    ...
    $rc = ciniki_classes_checkAccess($ciniki, $args['tnid'], 'ciniki.classes.classUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    return ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.classes.class', $args['class_id'], $args);
}
?>
