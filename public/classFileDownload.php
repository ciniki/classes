...
function ciniki_classes_classFileDownload($ciniki) {
    ...
    if( !isset($rc['file']) ) {
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1802', 'msg'=>'Unable to find file'));
    }
    ...
    if( $rc['file']['extension'] == 'pdf' ) {
        ...
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1801', 'msg'=>'Unsupported file type'));
    }
    // Specify Filename
