...
// Description
// ===========
// This method will remove a file from an class.
//
// Arguments
// ---------
// api_key:
...
// <rsp stat='ok' />
//
function ciniki_classes_classFileDelete(&$ciniki) {
    //  
    ...
    if( !isset($rc['file']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.classes.11', 'msg'=>'Unable to find existing item'));
    }
    $uuid = $rc['file']['uuid'];
